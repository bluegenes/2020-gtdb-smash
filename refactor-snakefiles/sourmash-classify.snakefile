...
### what do we need for gather, not building indices?
### 1. acc2filenames (in case sigs are not yet built)
### 2. sample :: accs (so can aggregate sigs for gather)
### == basically the same info. heh.

#### THIS --> just gather
### Separate --> just index


sampleInfo=config["gather_samples"]
accession2filenames = {}
