...
python scripts/grow-sbtmh.py test_grow_sbt --sbt test_grow_sbt_subset/sbt-7paths_dayhoff_k13.sbt.zip --ksize 13 --input-is-directory --scaled 1 --alphabet dayhoff --track-abundance --subset-csv gtdb_evol_groups_first_seven.tsv
